...
public class CategoryRepositoryImpl implements CategoryRepository {
    ...
    public List<Category> findAll(Integer userId) throws EtResourceNotFoundException {
        try {
            ...
            throw new EtBadRequestException("Invalid details. Failed to get all category");
        }
    }
    ...
    public void removeById(Integer userId, Integer categoryId) throws EtResourceNotFoundException {
        this.removeAllCaTransactions(categoryId);
        jdbcTemplate.update(SQL_DELETE_CATEGORY, new Object[]{userId, categoryId});
    }

    private void removeAllCaTransactions(Integer categoryId) {
