...
public class TransactionRepositoryImpl implements TransactionRepository {
    ...
    public List<Transaction> findAll(Integer userId, Integer categoryId) throws EtResourceNotFoundException {
        try {
            ...
            throw new EtBadRequestException("Invalid details. Failed to find all transactions");
        }
    }
    ...
    public Transaction findById(Integer userId, Integer categoryId, Integer transactionId) throws EtResourceNotFoundException {
        try {
            ...
            throw new EtBadRequestException("Invalid details. Failed to find transaction by id");
        }
    }

    @Override
    public Integer create(Integer userId, Integer categoryID, Double amout, String note, Long transactionDate) throws EtBadRequestException {
        try {
            ...
            throw new EtBadRequestException("Invalid details. Failed to create transaction");
        }
    }
    ...
    public void update(Integer userId, Integer categoryId, Integer transactionId, Transaction transaction) throws EtBadRequestException {
        try {
            ...
            throw new EtBadRequestException("Invalid details. Failed to update transaction");
        }
    }
