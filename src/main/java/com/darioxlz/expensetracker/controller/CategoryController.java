...
import com.darioxlz.expensetracker.services.CategoryService;
...
public class CategoryController {
    ...
    public ResponseEntity<Map<String, Boolean>> deleteCategoryById(HttpServletRequest request, @PathVariable("categoryId") Integer categoryId) {
        int userId = (Integer) request.getAttribute("userId");
